	...
	*/
    removeUnusedCharts: function(o) {
        ...
        if (!me.charts['column'] && !me.charts['bar']) {
            ...
            o['c:chartSpace']['c:chart']['c:plotArea']['c:barChart'] =
                o['c:chartSpace']['c:chart']['c:plotArea']['c:barChart'][0];
            addId(o['c:chartSpace']['c:chart']['c:plotArea']['c:barChart']);
        } else if (!me.charts['column'] && me.charts['bar']) {
            o['c:chartSpace']['c:chart']['c:plotArea']['c:barChart'] =
                o['c:chartSpace']['c:chart']['c:plotArea']['c:barChart'][1];
            addId(o['c:chartSpace']['c:chart']['c:plotArea']['c:barChart']);
        } else {
    ...
    writeChart: function(cb) {
        ...
        me.read({ file: 'xl/charts/chart1.xml' }, function(err, o) {
            ...
            _.each(me.titles, function(t, i) {
                ...
                if (chart === 'column') {
                    if (series.color) {
                        r['c:spPr'] = ColorTag(series.color);
                    }
                }
...
function LineDataPointTag(id, color, series, f) {
    return {
        'c:idx': IdxTag(id),
        'c:marker': {
            'c:spPr': _.extend(ColorTag(color), { 'a:ln': ColorTag(color) })
        },
        'c:bubble3D': {
            $: {
                val: 0
...
function ColumnDataPointTag(id, color) {
    return {
        'c:idx': IdxTag(id),
        'c:spPr': ColorTag(color),
        'c:invertIfNegative': {
            $: {
                val: 0
            }
